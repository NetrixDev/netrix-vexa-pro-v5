...
class LoadingScreen:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Netrix VEXTA Pro v5")
    ...
    def create_loading_ui(self):
        ...
        title_label = tk.Label(main_frame, text="🎯 NETRIX VEXTA PRO", 
                             font=("Arial Black", 20), 
                             fg='#00aaff', bg='#1a1a1a')
...
class AutoClickerApp:
    ...
    def build_ui(self):
        ...
        ctk.CTkLabel(footer_frame, text="© 2025 NetrixDev - Premium Edition", font=("Arial", 10, "italic"), text_color="#666666").pack()
